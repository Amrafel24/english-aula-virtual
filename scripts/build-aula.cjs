...
const publicFiles=['index.html','styles.css','script.js','english-data.js','english-mascot.png','sw.js','english-game.html','english-game.css','english-game-engine.js','english-game.js','match-pairs.js','match-pairs.css','aula.js','aula.css','aula-video.js'];
